...
PROJECTS := Project1-master raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

Project1-master: raylib
ifneq (,$(Project1_master_config))
	@echo "==== Building Project1-master ($(Project1_master_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Project1-master.make config=$(Project1_master_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Project1-master.make clean
